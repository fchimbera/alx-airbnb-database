...
SELECT Bookings.*, Users.first_name, Users.last_name FROM Bookings INNER JOIN Users ON Bookings.user_id = Users.user_id;
...
SELECT Properties.*, Reviews.rating, Reviews.comment FROM Properties LEFT JOIN Reviews ON Properties.property_id = Reviews.property_id;
